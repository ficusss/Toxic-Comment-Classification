...
namespace tcc
{
	...
	*/
	...
	public:
		...
		@return Дерево двоичного поиска, содержащее в себе слова, приведенные к начальной форме
		*/
		virtual tcc::BOW stem(std::vector<json> text) = 0;
		/**
		@brief Виртуальная функция для стемминга
		@param text Строка, содержащая в себе текст, подлежащий стеммингу
		@return Вектор слов, приведенных к начальной формe
		*/
	...
	*/
	...
	public:
		...
		@param text Структура данных, содержащая в себе текст, подлежащий стеммингу
		@return Дерево двоичного поиска, содержащая в себе слова, приведенные к начальной форме
		*/
